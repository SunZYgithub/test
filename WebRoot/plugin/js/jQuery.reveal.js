	...
	*********************************************************/
	$.fn.revealListener = function(){ 
		...
		$('a[data-reveal-id]').on('click', function(e) {
			...
			$('#'+modalLocation).reveal($(this).data());
			console.log("a  DREID")
			console.log("modalLocation :"+modalLocation )
		});	
		/****绑定<i>标签****/
        ...
        return this.each(function() {
            ...
            *****************************/
            ...
            /*****************************
                        创建背景元素
            *****************************/
        	//console.log("modalBG.length:"+modalBG.length)
        	console.log(modal)
			if(modalBG.length == 0) {
				modalBG = $('<div class="'+options.bg+'" />').insertAfter(modal);
			}
        	//console.log("options.bg:"+options.bg)
            ...
            *****************************/
			...
			modal.bind('reveal:open', function () {
				console.log("打开1")
				console.log(options)
				console.log("options.dismissmodalclass:"+options.dismissmodalclass)
