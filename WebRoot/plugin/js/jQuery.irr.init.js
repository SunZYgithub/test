...
(function($) {
	...
	**************************/	
    ...
    /*console.log("options.pageframe1:"+options.pageframe)
    console.log('Start init11');
    console.log("options.pageframe3:"+options.pageframe)
    ...
    $.ajax({
		...
		success: function (data) {
			...
			if(data.EXISTS=='Y'){
				...
				if(autoquery=='Y'){
            		$(options.refresh).click();
            		console.log("opRefresh:"+options.refresh)
            		console.log("autoyy")
            	}else{
            		console.log("autoNN")
            		/**modify by bird 2016-12-6**/
					...
					$('#'+options.pageframe+' i[data-pagetype="nextpage"]').css('display','none');
					$('#'+options.pageframe+' i[data-reveal-id="query"]').click();
					console.log("options.pageframe222:"+options.pageframe)
            	}
			}			
		},
		error: function () {
